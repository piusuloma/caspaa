  ...
  const receiptHtml = `
    ...
    <head>
      ...
      <style>
        ...
        .logo{background:#234e70;color:#fff;text-align:center;padding:16px;border-radius:12px 12px 0 0;font-size:20px;font-weight:700;}
    ...
    <body>
      ...
      <div class="body">
        ...
        <div style="text-align:center;margin-top:20px;">
          <button onclick="window.print()" style="background:#234e70;color:#fff;border:none;padding:10px 24px;border-radius:8px;cursor:pointer;font-size:14px;">Print Receipt</button>
        </div>
