  ...
  navFor(role) {
    const menus = {
      superadmin: [
        ...
        { key: 'sa_audit',       label: 'Audit Log',       icon: 'search' },
      ...
      schooladmin: [
        ...
        { key: 'adm_admissions',    label: 'Admissions',        icon: 'user' },
        { key: 'adm_frontdesk',     label: 'Front Desk',        icon: 'bell' },
        { key: 'adm_workforce',     label: 'Staff & HR',        icon: 'user' },
        { key: 'adm_staff',         label: 'Teachers',          icon: 'teacher' },
        ...
        { key: 'adm_operations',    label: 'Operations',        icon: 'building' },
        { key: 'adm_comms',         label: 'Communications',    icon: 'chat' },
        { key: 'cal_main',          label: 'Calendar',          icon: 'calendar' },
        { key: 'adm_houses',        label: 'Inter House Points',      icon: 'sparkles' },
        { key: 'adm_transport',     label: 'Transport',         icon: 'bus' },
        { key: 'adm_feedback',      label: 'Surveys',           icon: 'edit' },
        { key: 'adm_health',        label: 'Sickbay',           icon: 'shield' },
        { key: 'adm_support',       label: 'Help & Support',    icon: 'info' },
        { key: 'adm_settings',      label: 'School Settings',   icon: 'settings' },
        { key: 'adm_audit',         label: 'Audit Log',         icon: 'search' }
      ],
      principal: [
        { key: 'adm_dashboard',  label: 'Dashboard',      icon: 'dashboard' },
        { key: 'adm_people',     label: 'Students',       icon: 'students' },
      ...
      finance: [
        ...
        { key: 'fin_payments',   label: 'Payments',        icon: 'naira' },
      ...
      teacher: [
        ...
        { key: 'tch_assessments', label: 'Assessments',       icon: 'check' },
        { key: 'tch_lessons',    label: 'Lessons & Content', icon: 'book' },
        { key: 'tch_payslip',    label: 'My Payslip',         icon: 'fees' },
        { key: 'cal_main',       label: 'Calendar',           icon: 'calendar' },
        { key: 'tch_timetable',  label: 'My Schedule',        icon: 'bell' },
        { key: 'tch_houses',     label: 'Inter House Points',        icon: 'sparkles' },
        { key: 'tch_diary',      label: 'Diary',              icon: 'edit' },
      ...
      parent: [
        ...
        { key: 'par_wallet',     label: 'Wallet & Ledger', icon: 'wallet' },
        ...
        { key: 'par_houses',     label: 'Inter House Points', icon: 'sparkles' },
        { key: 'par_transport',  label: 'Transport',       icon: 'bus' },
        { key: 'par_health',     label: 'Health',          icon: 'shield' },
        { key: 'par_feedback',   label: 'Surveys',         icon: 'edit' }
      ],
      student: [
        ...
        { key: 'stu_timetable',  label: 'Timetable',       icon: 'classes' },
        { key: 'cal_main',       label: 'Calendar',        icon: 'calendar' },
        { key: 'stu_houses',     label: 'Inter House Points', icon: 'sparkles' },
        { key: 'stu_wallet',     label: 'My Wallet',       icon: 'wallet' }
      ]
    };
