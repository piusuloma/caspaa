...
function seedDatabase() {
  ...
  schools.forEach(s => {
    if (!s.branding) s.branding = {
      primaryColor: s.id === 'sch_brightlights' ? '#234e70' : (s.id === 'sch_horizon' ? '#1e40af' : '#0f766e'),
